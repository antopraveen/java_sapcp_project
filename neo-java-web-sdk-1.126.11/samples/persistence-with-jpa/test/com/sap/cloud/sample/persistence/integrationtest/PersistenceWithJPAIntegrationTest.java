 ...
 */
public class PersistenceWithJPAIntegrationTest {
     ...
     */
    @Test
    public void testPersistenceWithJPAServlet() throws IOException, SAXException {
        // Call servlet
        request = new GetMethodWebRequest(serverUrl + "/persistence-with-jpa/");
        response = wc.getResponse(request);
        Assert.assertThat(response.getText(), containsString("Persistence with JPA"));
    }
